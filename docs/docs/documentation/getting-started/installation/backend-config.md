...
| TOKEN_TIME                    |          48           | The time in hours that a login/auth token is valid. Must be <= 87600 (10 years, in hours). Some browsers may limit this to 400 days automatically.      |

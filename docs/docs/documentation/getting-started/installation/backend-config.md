...
| OIDC_PICTURE_CLAIM                                                                  | picture | The claim holding a URL to the user's profile image, used to set their Mealie avatar on login. Leave empty to disable avatar syncing. The URL must be HTTPS and resolve to a public address.                                                                                                            |

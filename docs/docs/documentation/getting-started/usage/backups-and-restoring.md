...
- If this action is successful you will be logged out and you will need to log back in to complete the restore. If after restoring, you cannot log in again but don't see any "Invalid credentials" error message, try restarting the application. 

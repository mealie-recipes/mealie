      ...
      <v-card-text v-else>
        ...
        <v-row>
          <!--
           ...
           -->
          <v-col v-if="!isCookMode || isEditForm" cols="12" sm="6" md="6" lg="4" class="col-sm-scroll">
          ...
          <!--
            ...
            rendered.
           -->
          <v-col cols="12" sm="6" :md="6 + (isCookMode ? 1 : 0) * 6" :lg="8 + (isCookMode ? 1 : 0) * 4" class="col-sm-scroll">

...
import { PublicCategoriesApi, PublicTagGroupsApi, PublicTagsApi, PublicToolsApi } from "./explore/organizers";
...
export class ExploreApi extends BaseAPI {
  ...
  public tagGroups: PublicTagGroupsApi;
  ...
  constructor(requests: ApiRequestInstance, groupSlug: string) {
    ...
    this.tagGroups = new PublicTagGroupsApi(requests, groupSlug);

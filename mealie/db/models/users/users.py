...
class User(SqlAlchemyBase, BaseMixins):
    ...
    # Recipe display preferences; null means "fall back to the household default"
    preferred_unit_system: Mapped[str | None] = mapped_column(String, nullable=True, default=None)
    preferred_temperature_unit: Mapped[str | None] = mapped_column(String, nullable=True, default=None)

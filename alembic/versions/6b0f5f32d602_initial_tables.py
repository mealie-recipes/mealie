...
Revises: 
Create Date: 2022-01-27 09:14:28.825581
...
def upgrade():
    # TODO Only create tables if they don't exist?
    ...
    op.create_index(
        op.f("ix_group_data_exports_group_id"),
        "group_data_exports",
        ["group_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_group_events_notifiers_group_id"),
        "group_events_notifiers",
        ["group_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_group_reports_category"),
        "group_reports",
        ["category"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_group_meal_plans_date"),
        "group_meal_plans",
        ["date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_group_meal_plans_entry_type"),
        "group_meal_plans",
        ["entry_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_group_meal_plans_group_id"),
        "group_meal_plans",
        ["group_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_group_meal_plans_title"),
        "group_meal_plans",
        ["title"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("owned_recipes_id", sa.Integer(), nullable=True),
        sa.ForeignKeyConstraint(
            ["group_id"],
            ["groups.id"],
        ),
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_group_events_notifiers_group_id"),
        table_name="group_events_notifiers",
    )

...
def upgrade():
    ...
    op.add_column(
        ...
        sa.Column("lock_recipe_edits_from_other_households", sa.Boolean(), nullable=True, default=True),
    )
    op.add_column("users", sa.Column("can_manage_household", sa.Boolean(), nullable=True), default=False)

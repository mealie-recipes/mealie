...
def test_get_all_households(api_client: TestClient, unique_user: TestUser):
    unique_user.repos.groups.patch(unique_user.group_id, {"preferences": {"private_group": False}})
    households = [
...
def test_get_all_households_public_only(api_client: TestClient, unique_user: TestUser):
    unique_user.repos.groups.patch(unique_user.group_id, {"preferences": {"private_group": False}})
...
def test_get_household(api_client: TestClient, unique_user: TestUser, is_private_household: bool):
    unique_user.repos.groups.patch(unique_user.group_id, {"preferences": {"private_group": False}})

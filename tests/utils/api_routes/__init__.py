...
recipes_create_social = "/api/recipes/create/social"
"""`/api/recipes/create/social`"""
recipes_create_social_stream = "/api/recipes/create/social/stream"
"""`/api/recipes/create/social/stream`"""

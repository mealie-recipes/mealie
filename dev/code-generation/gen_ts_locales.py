...
LOCALE_DATA: dict[str, LocaleData] = {
    ...
    "ar-SA": LocaleData(name="العربية (Arabic)", dir=LocaleTextDirection.RTL),
    ...
    "en-GB": LocaleData(name="British English", plural_type=LocalePluralType.NO_UNIT),
    "en-US": LocaleData(name="American English", plural_type=LocalePluralType.NO_UNIT),
    ...
    "he-IL": LocaleData(name="עברית (Hebrew)", dir=LocaleTextDirection.RTL),
    ...
    "ja-JP": LocaleData(name="日本語 (Japanese)", plural_type=LocalePluralType.NEVER),
    "ko-KR": LocaleData(name="한국어 (Korean)", plural_type=LocalePluralType.NEVER),
    ...
    "tr-TR": LocaleData(name="Türkçe (Turkish)", plural_type=LocalePluralType.NEVER),
    "uk-UA": LocaleData(name="Українська (Ukrainian)"),
    "vi-VN": LocaleData(name="Tiếng Việt (Vietnamese)", plural_type=LocalePluralType.NEVER),
    "zh-CN": LocaleData(name="简体中文 (Chinese simplified)", plural_type=LocalePluralType.NEVER),
    "zh-TW": LocaleData(name="繁體中文 (Chinese traditional)", plural_type=LocalePluralType.NEVER),
}
...
def get_languages() -> list[TargetLanguage]:
    ...
    models.insert(
        ...
        TargetLanguage(
            ...
            plural_type=LocalePluralType.NO_UNIT,
            threeLettersCode="en",
            twoLettersCode="en",
            progress=100,
        ),
    ...
    for model in models:
        if model.locale in LOCALE_DATA:
            ...
            model.plural_type = locale_data.plural_type
